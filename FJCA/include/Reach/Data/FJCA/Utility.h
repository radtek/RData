...
#ifndef FJCA_Utility_INCLUDED
#define FJCA_Utility_INCLUDED
...
class FJCA_API Utility
	/// Various utility functions for FJCA.
{
public:
...
private:
	Utility();
		/// Maps FJCA column declared types to Poco::Data types through
		/// static TypeMap member.
		/// 
		/// Note: FJCA is type-agnostic and it is the end-user responsibility
